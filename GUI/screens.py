...
class HomeScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.heading = FloatLayout(
            size_hint=(1, None),
            height=40,
            pos_hint={'top': 1}  # Position the heading at the top of the screen
        )
        ...
        self.headingButton.bind(on_press=self.new_env)
        self.layout.add_widget(self.heading)

        ## SubScreen ##
        # Central Homepage Button
...
class EnvControl(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.fanSwitch = Switch(
            ...
            # on_active = self.fan_on(self, True),
            # on_inactive = self.fan_off(self, False)
        )
        ...
        self.lightSwitch = Switch(
            ...
            size_hint=(0.25, 0.25),
            pos_hint={'center_x': 0.7, 'center_y': 0.5},
            # on_active = self.light_on(self, True),
            # on_inactive = self.light_off(self, False)
        )
